...
ActiveRecord::Schema.define(:version => 20111010215735) do
  ...
  add_index "api_keys", ["public"], :name => "index_api_keys_on_public", :unique => true
  ...
  add_index "partners", ["username"], :name => "index_partners_on_username", :unique => true
